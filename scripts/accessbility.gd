...
func _on_text_size_item_selected(index: int) -> void:
	match index:
		0: get_tree().change_scene_to_file("res://scenes/Options/accessbilitySmall.tscn")
		1: get_tree().change_scene_to_file("res://scenes/Options/accessbility.tscn")
...
func _on_capitilzation_pressed() -> void:
	...
	PlayerData.save_settings()  # save immediately
...
func _on_voice_narration_item_selected(index: int):
	match index:
		0: Settings.narration_gender = "male"
		1: Settings.narration_gender = "female"
	PlayerData.save_settings()  # save immediately
...
func _on_color_theme_item_selected(index: int) -> void:
	match index:
		0: pass
		1: get_tree().change_scene_to_file("res://scenes/Options/accessbilityBlue.tscn")
